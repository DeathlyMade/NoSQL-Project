...
public class Oplog_PostgresDAO2 {

    private static final String URL = "jdbc:postgresql://localhost:5432/postgres_db2";
    private static final String USER = "postgres";
    private static final String PASSWORD = "root";

    public static void createOplogTable() throws SQLException {
        String createTableSQL = "CREATE TABLE IF NOT EXISTS postgres2_oplog (" +
        ...
        try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD);
            ...
            //System.out.println("Table 'postgres2_oplog' is ready.");
        }
    }
    ...
    public static void insertOplogEntry(int studentId, String targetVal) throws SQLException {
        ...
        createOplogTable();
        String insertSQL = "INSERT INTO postgres2_oplog (student_id, target_val) VALUES (?, ?)";
        try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD);
    ...
    public static ArrayList<String[]> readOplogEntries() throws SQLException {
        ...
        String selectSQL = "SELECT * FROM postgres2_oplog";
        try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD);
             Statement stmt = conn.createStatement();
            ...
            while (rs.next()) {
                ...
                row[4] = "SQL2"; // Added to differentiate from other DBs
                entries.add(row);
            }
        }
        return entries;
